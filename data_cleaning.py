...
# from kmeans import *
# from data_cleaning_pandas import *

# grouped_df.rename({'country_name' : 'country', 'iso_3166_1_alpha_3': 'iso_a3'}, axis=1, inplace=True)
# print(grouped_df.head())

# new_df = grouped_df.merge(deaths_df, how='left', on='country')
# print(new_df.head())